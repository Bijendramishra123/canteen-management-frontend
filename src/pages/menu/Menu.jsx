...
import { FiSearch, FiShoppingCart, FiStar, FiImage, FiRefreshCw, FiAlertCircle } from 'react-icons/fi'
              ...
              >
                <div className="relative h-52 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    {food.availability ? (
                      <span className="bg-green-500 text-white px-2 py-1 rounded-lg text-xs font-medium shadow-lg">
                        Available
                      </span>
                    ) : (
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <span className={`text-2xl font-bold ${!food.availability ? 'text-gray-400' : 'text-blue-600'}`}>
                        ₹{food.price}
                      </span>
                    </div>
                    <motion.button
